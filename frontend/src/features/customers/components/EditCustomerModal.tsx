...
interface EditCustomerModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (id: string, customerData: UpdateCustomerRequest) => Promise<void>;
...
export function EditCustomerModal({ isOpen, onClose, onSubmit, customer, loading = false }: EditCustomerModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await onSubmit(customer._id, formData);
      onClose();
    } catch (error) {
  ...
  const handleChange = (field: keyof UpdateCustomerRequest) => (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
    setFormData(prev => ({
      ...prev,
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 text-gray-600 pr-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors ${
