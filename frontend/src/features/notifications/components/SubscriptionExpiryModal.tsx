...
export function SubscriptionExpiryModal({ isOpen, onClose, onSubmit, loading }: SubscriptionExpiryModalProps) {
      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-md">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-2">
            ...
            <h3 className="text-lg font-semibold text-gray-900">Create Subscription Expiry Notifications</h3>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <p className="text-sm text-gray-500 mt-1">
              Notifications will be sent to customers whose subscriptions expire in {daysBefore} days
            </p>
          </div>
          ...
          <div className="flex space-x-3">
            ...
            >
              {loading ? 'Creating...' : 'Create Notifications'}
            </button>
            <button
              type="button"
              onClick={onClose}
