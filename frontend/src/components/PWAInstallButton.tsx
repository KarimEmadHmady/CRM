...
const InstallPWAButton: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // For development, always show the button on desktop
    if (process.env.NODE_ENV === 'development' && !iOS) {
  ...
  return (
    <>
      <div
        className="fixed z-50 flex tems-end justify-center w-full px-2 pb-6 pointer-events-none sm:justify-end"
